...
export function handleDailyIncomeTransfer (event: Transfer) : void
{
    ...
    if (event.params.from.toHexString() == "0x444b860128b7bf8c0e864bdc3b7a36a940db7d88"
    && event.params.to.toHexString() == "0x8de82c4c968663a0284b01069dde6ef231d0ef9b")
    {
    ...
    if (event.params.from.toHexString() == "0x3efc97a8e23f463e71bf28eb19690d097797eb17"
    && event.params.to.toHexString() == "0x8de82c4c968663a0284b01069dde6ef231d0ef9b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    if (event.params.from.toHexString() == "0xe2fa197eaa5c726426003074147a08beaa59403b"
    && event.params.to.toHexString() == "0x8de82c4c968663a0284b01069dde6ef231d0ef9b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    if (event.params.from.toHexString() == "0x7a56d65254705b4def63c68488c0182968c452ce"
    && event.params.to.toHexString() == "0xda25ee226e534d868f0dd8a459536b03fee9079b")
    {
        let id = event.address.toHexString()
        .concat("-")
        .concat(event.transaction.hash.toHexString())
    ...
    if (event.params.from.toHexString() == "0x3a494d79aa78118795daad8aeff5825c6c8df7f1"
    && event.params.to.toHexString() == "0xda25ee226e534d868f0dd8a459536b03fee9079b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    if (event.params.from.toHexString() == "0xaa8dddfe7dfa3c3269f1910d89e4413dd006d08a"
    && event.params.to.toHexString() == "0xda25ee226e534d868f0dd8a459536b03fee9079b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    if (event.params.from.toHexString() == "0xaae82e3c89e15e6f26f60724f115d5012363e030"
    && event.params.to.toHexString() == "0xda25ee226e534d868f0dd8a459536b03fee9079b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    if (event.params.from.toHexString() == "0x4b92d19c11435614cd49af1b589001b7c08cd4d5"
    && event.params.to.toHexString() == "0xb65cef03b9b89f99517643226d76e286ee999e77")
    {
        let id = event.address.toHexString()
        .concat("-")
        .concat(event.transaction.hash.toHexString())
    ...
    if (event.params.from.toHexString() == "0xf4146a176b09c664978e03d28d07db4431525dad"
    && event.params.to.toHexString() == "0xda25ee226e534d868f0dd8a459536b03fee9079b")
    {
        let id = event.address.toHexString()
        .concat("-")
    ...
    && event.params.to.toHexString() == "0xb6ea1d3fb9100a2cf166febe11f24367b5fcd24a")
    {
        let id = event.address.toHexString()
        .concat("-")
        .concat(event.transaction.hash.toHexString())
    ...
    if (event.params.from.toHexString() == "0x0000000000000000000000000000000000000000"
    && event.params.to.toHexString() == "0x3b823864cd0cbad8a1f2b65d4807906775becaa7")
    {
        let id = event.address.toHexString()
        .concat("-")
        .concat(event.transaction.hash.toHexString())
